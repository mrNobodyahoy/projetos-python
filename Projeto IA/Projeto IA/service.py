...
def exibirTabelaComparacao():
    if len(dadosComparacao) == 0:
        print("\nNenhum dado de busca para comparar.")
        return

    cabecalhos = ["Algoritmo", "Nós Expandidos", "Tempo", "Custo Acumulado"]
    
    print("\n" + "="*55)
    print("TABELA DE COMPARAÇÃO".center(55))
    print("="*55 + "\n")
    
    print(tabulate(dadosComparacao, headers=cabecalhos, tablefmt="grid"))